...
export default function PurchaseBillDetails(){
  ...
  const [payment,setPayment]=useState({payment_date:new Date().toISOString().slice(0,10),mode:'NEFT',reference_number:'',amount:0,paid_by:'Arun Verma',notes:''});
