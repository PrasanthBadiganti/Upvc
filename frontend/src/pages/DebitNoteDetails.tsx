...
export default function DebitNoteDetails(){
  ...
  return <>
    ...
    <div className="metric-grid invoice-summary-cards">
      <Card className="invoice-summary-card"><div className="metric-icon blue"><FileText size={18}/></div><div><small>Debit Note Number</small><strong>{note.number}</strong></div></Card>
