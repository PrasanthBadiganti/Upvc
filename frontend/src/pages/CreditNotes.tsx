...
export default function CreditNotes(){
  ...
  const cancel=async(n:CreditNote)=>{if(!(await confirm({title:`Cancel ${n.number}?`,message:'The invoice balance will be restored.',confirmLabel:'Cancel note',cancelLabel:'Keep it',isDangerous:true})))return;await api.post(`/credit-notes/${n.id}/cancel`);load();};
